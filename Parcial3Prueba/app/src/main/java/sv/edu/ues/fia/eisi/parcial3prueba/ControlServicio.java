...
public class ControlServicio {
    ...
    public static List<Libro> obtenerLibrosL(String json, Context ctx) {
        ...
        try {
            ...
            for (int i = 0; i < unidadJson.length(); i++) {
                ...
                libro.setIdLibro(obj.getInt("idLibro"));
                libro.setTitulo(obj.getString("titulo"));
                libro.setAutor(obj.getString("autor"));
                libro.setCategoria(obj.getString("categoria"));
                libro.setPrecio(obj.getDouble("precio"));
    ...
    public static List<String> obtenerLibros(String json, Context ctx) {

        List<String> listaLibro = new ArrayList<String>();
