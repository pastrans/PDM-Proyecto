...
-- Table: OPCIONCRUD
--==============================================================
create table OPCIONCRUD (IDOPCION             CHAR(3)              not null,DESOPCION            VARCHAR(30)          not null,NUMCRUD              INTEGER              not null,primary key (IDOPCION));


--==============================================================
-- Table: UNIDAD
--==============================================================
create table UNIDAD (IDUNIDAD             INTEGER PRIMARY KEY AUTOINCREMENT,NOMBREENT            VARCHAR(15)          not null,DESCRIPCIONENT       VARCHAR(500)         not null,PRIORIDAD            INTEGER              not null);


--==============================================================
-- Table: USUARIO
--==============================================================
create table USUARIO (IDUSUARIO            CHAR(2)              not null,IDUNIDAD             INTEGER,NOMBREUSUARIO        VARCHAR(30)          not null,CLAVEUSUARIO         CHAR(5)              not null,NOMBREPERSONAL       VARCHAR(30)          not null,APELLIDOPERSONAL     VARCHAR(30)          not null,CORREOPERSONAL       VARCHAR(50),primary key (IDUSUARIO),foreign key (IDUNIDAD)      references UNIDAD (IDUNIDAD));

--==============================================================
-- Table: ACCESOUSUARIO
--==============================================================
create table ACCESOUSUARIO (IDACCESOUSUARIO      INTEGER PRIMARY KEY AUTOINCREMENT,IDOPCION             CHAR(3),IDUSUARIO            CHAR(2),foreign key (IDOPCION)      references OPCIONCRUD (IDOPCION),foreign key (IDUSUARIO)      references USUARIO (IDUSUARIO));


--==============================================================
-- Index: ACCESOUSUARIO_PK
--==============================================================
create unique index ACCESOUSUARIO_PK on ACCESOUSUARIO (IDACCESOUSUARIO ASC);

--==============================================================
-- Index: RELATIONSHIP_23_FK
--==============================================================
create  index RELATIONSHIP_23_FK on ACCESOUSUARIO (IDOPCION ASC);

--==============================================================
-- Index: RELATIONSHIP_29_FK
--==============================================================
create  index RELATIONSHIP_29_FK on ACCESOUSUARIO (IDUSUARIO ASC);

--==============================================================
-- Table: CICLO
--==============================================================
create table CICLO (IDCICLO              INTEGER PRIMARY KEY AUTOINCREMENT,INICIO               DATE                 not null,FIN                  DATE                 not null,NOMBRECICLO          VARCHAR(20)          not null,ESTADOCICLO          smallint             not null,INICIOPERIODOCLASE   DATE                 not null,FINPERIODOCLASE      DATE                 not null);

--==============================================================
-- Index: CICLO_PK
--==============================================================
create unique index CICLO_PK on CICLO (IDCICLO ASC);

--==============================================================
-- Table: MATERIA
--==============================================================
create table MATERIA (CODMATERIA           VARCHAR(6)           not null,IDUNIDAD             INTEGER,NOMBREMAT            VARCHAR(25)          not null,MASIVA               smallint             not null,primary key (CODMATERIA),foreign key (IDUNIDAD)      references UNIDAD (IDUNIDAD));

--==============================================================
-- Table: CICLOMATERIA
--==============================================================
create table CICLOMATERIA (IDCICLOMATERIA       INTEGER PRIMARY KEY AUTOINCREMENT,IDCICLO              INTEGER,CODMATERIA           VARCHAR(6),foreign key (IDCICLO)      references CICLO (IDCICLO),foreign key (CODMATERIA)      references MATERIA (CODMATERIA));

--==============================================================
-- Index: CICLOMATERIA_PK
--==============================================================
create unique index CICLOMATERIA_PK on CICLOMATERIA (IDCICLOMATERIA ASC);
--==============================================================
-- Index: SE_DA_FK
--==============================================================
create  index SE_DA_FK on CICLOMATERIA (IDCICLO ASC);
--==============================================================
-- Index: IMPARTIDA_FK
--==============================================================
create  index IMPARTIDA_FK on CICLOMATERIA (CODMATERIA ASC);

--==============================================================
-- Index: CORDINA_FK
--==============================================================
create  index CORDINA_FK on CICLOMATERIA (IDUSUARIO ASC);

--==============================================================
-- Table: COORDINACION
--==============================================================
create table COORDINACION (IDCOORDINACION       INTEGER PRIMARY KEY AUTOINCREMENT,IDUSUARIO            CHAR(2),IDCICLOMATERIA       INTEGER,TIPOCOORDINACION     VARCHAR(30)          not null,foreign key (IDUSUARIO)      references USUARIO (IDUSUARIO),foreign key (IDCICLOMATERIA)      references CICLOMATERIA (IDCICLOMATERIA));

--==============================================================
-- Index: COORDINACION_PK
--==============================================================
create unique index COORDINACION_PK on COORDINACION (IDCOORDINACION ASC);

--==============================================================
-- Index: PERSONAL_REALIZA_COORDINACION_FK
--==============================================================
create  index PERSONAL_REALIZA_COORDINACION_FK on COORDINACION (IDUSUARIO ASC);
--==============================================================
-- Index: COORDINACION_DE_MATERIA_FK
--==============================================================
create  index COORDINACION_DE_MATERIA_FK on COORDINACION (IDCICLOMATERIA ASC);

--==============================================================
-- Table: DIA
--==============================================================
create table DIA (IDDIA                INTEGER PRIMARY KEY AUTOINCREMENT,NOMBREDIA            VARCHAR(25)          not null);

--==============================================================
-- Table: HORARIO
--==============================================================
create table HORARIO (IDHORA               INTEGER PRIMARY KEY AUTOINCREMENT,HORAINICIO           TIME                 not null,HORAFINAL            TIME                 not null);

--==============================================================
-- Table: ENCARGADO
--==============================================================
create table ENCARGADO (IDENCARGADO          INTEGER PRIMARY KEY AUTOINCREMENT,IDUSUARIO            CHAR(2),foreign key (IDUSUARIO)      references USUARIO (IDUSUARIO));

--==============================================================
-- Table: TIPOLOCAL
--==============================================================
create table TIPOLOCAL (IDTIPOLOCAL          INTEGER PRIMARY KEY AUTOINCREMENT,IDENCARGADO          INTEGER,NOMBRETIPO           VARCHAR(25)          not null,foreign key (IDENCARGADO)      references ENCARGADO (IDENCARGADO));


--==============================================================
-- Table: LOCAL
--==============================================================
create table LOCAL (IDLOCAL              INTEGER PRIMARY KEY AUTOINCREMENT,IDTIPOLOCAL          INTEGER,NOMBRELOCAL          VARCHAR(25)          not null,CAPACIDAD            INTEGER              not null,foreign key (IDTIPOLOCAL)      references TIPOLOCAL (IDTIPOLOCAL));

--==============================================================
-- Table: EVENTOESPECIAL
--==============================================================
create table EVENTOESPECIAL (IDEVENTOESPECIAL     INTEGER PRIMARY KEY AUTOINCREMENT,IDCICLOMATERIA       INTEGER,NOMBREEVENTO         VARCHAR(100)         not null,FECHAEVENTO          DATE                 not null,DESCRIPCIONEVENTO    VARCHAR(300),foreign key (IDCICLOMATERIA)      references CICLOMATERIA (IDCICLOMATERIA));

--==============================================================
-- Table: TIPOGRUPO
--==============================================================
create table TIPOGRUPO (IDTIPOGRUPO          INTEGER PRIMARY KEY AUTOINCREMENT,NOMBRETIPOGRUPO      VARCHAR(25)          not null);

--==============================================================
-- Table: GRUPO
--==============================================================
create table GRUPO (IDGRUPO              INTEGER PRIMARY KEY AUTOINCREMENT,IDTIPOGRUPO          INTEGER,IDCICLOMATERIA       INTEGER,NUMERO               INTEGER              not null,foreign key (IDTIPOGRUPO)      references TIPOGRUPO (IDTIPOGRUPO),foreign key (IDCICLOMATERIA)      references CICLOMATERIA (IDCICLOMATERIA));
...
--==============================================================
create unique index DETALLERESERVA_PK on DETALLERESERVA (IDDETALLERESERVA ASC);
--==============================================================
-- Index: SE_IMPARTE_FK
--==============================================================
create  index SE_IMPARTE_FK on DETALLERESERVA (IDDIA ASC);

--==============================================================
-- Index: CONTIENE_FK
--==============================================================
create  index CONTIENE_FK on DETALLERESERVA (IDHORA ASC);

--==============================================================
-- Index: SE_IMPARTE_EN_FK
--==============================================================
create  index SE_IMPARTE_EN_FK on DETALLERESERVA (IDLOCAL ASC);

--==============================================================
-- Index: REALIZA_FK
--==============================================================
create  index REALIZA_FK on DETALLERESERVA (IDEVENTOESPECIAL ASC);

--==============================================================
-- Index: GRUPO_TIENE_DETRESERVA_FK
--==============================================================
create  index GRUPO_TIENE_DETRESERVA_FK on DETALLERESERVA (IDGRUPO ASC);
--==============================================================
-- Index: DIA_PK
--==============================================================
create unique index DIA_PK on DIA (IDDIA ASC);

--==============================================================
-- Index: ENCARGADO_PK
--==============================================================
create unique index ENCARGADO_PK on ENCARGADO (IDENCARGADO ASC);

--==============================================================
-- Index: ES_FK
--==============================================================
create  index ES_FK on ENCARGADO (IDUSUARIO ASC);

--==============================================================
-- Index: EVENTOESPECIAL_PK
--==============================================================
create unique index EVENTOESPECIAL_PK on EVENTOESPECIAL (IDEVENTOESPECIAL ASC);

--==============================================================
-- Index: PERTENECE_FK
--==============================================================
create  index PERTENECE_FK on EVENTOESPECIAL (IDCICLOMATERIA ASC);

--==============================================================
-- Table: FERIADOS
--==============================================================
create table FERIADOS (IDFERIADO            INTEGER PRIMARY KEY AUTOINCREMENT,IDCICLO              INTEGER,FECHAINICIOFERIADO   DATE                 not null,FECHAFINFERIADO      DATE                 not null,NOMBREFERIADO        VARCHAR(50)          not null,DESCRIPCIONFERIADO   VARCHAR(500)         not null,BLOQUEARRESERVAS     smallint             not null,foreign key (IDCICLO)      references CICLO (IDCICLO));

--==============================================================
-- Index: FERIADOS_PK
--==============================================================
create unique index FERIADOS_PK on FERIADOS (IDFERIADO ASC);
--==============================================================
-- Index: HAY_FK
--==============================================================
create  index HAY_FK on FERIADOS (IDCICLO ASC);

--==============================================================
-- Index: GRUPO_PK
--==============================================================
create unique index GRUPO_PK on GRUPO (IDGRUPO ASC);
--==============================================================
-- Index: ES_DE_FK
--==============================================================
create  index ES_DE_FK on GRUPO (IDTIPOGRUPO ASC);

--==============================================================
-- Index: REPARTIDA_FK
--==============================================================
create  index REPARTIDA_FK on GRUPO (IDCICLOMATERIA ASC);

--==============================================================
-- Index: HORARIO_PK
--==============================================================
create unique index HORARIO_PK on HORARIO (IDHORA ASC);

--==============================================================
-- Index: LOCAL_PK
--==============================================================
create unique index LOCAL_PK on LOCAL (IDLOCAL ASC);

--==============================================================
-- Index: ES_DE_UN_FK
--==============================================================
create  index ES_DE_UN_FK on LOCAL (IDTIPOLOCAL ASC);

--==============================================================
-- Index: MATERIA_PK
--==============================================================
create unique index MATERIA_PK on MATERIA (CODMATERIA ASC);

--==============================================================
-- Index: UNIDAD_IMPARTE_MATERIA_FK
--==============================================================
create  index UNIDAD_IMPARTE_MATERIA_FK on MATERIA (IDUNIDAD ASC);

--==============================================================
-- Index: OPCIONCRUD_PK
--==============================================================
create unique index OPCIONCRUD_PK on OPCIONCRUD (IDOPCION ASC);
...
-- Table: RESERVA
--==============================================================
create table RESERVA (IDRESERVA            INTEGER PRIMARY KEY AUTOINCREMENT,IDDETALLERESERVA     INTEGER,IDSOLICITUD          INTEGER,foreign key (IDDETALLERESERVA)      references DETALLERESERVA (IDDETALLERESERVA),foreign key (IDSOLICITUD)      references SOLICITUD (IDSOLICITUD));

--==============================================================
-- Index: RESERVA_PK
--==============================================================
create unique index RESERVA_PK on RESERVA (IDRESERVA ASC);

--==============================================================
-- Index: RESERVA_TIENE_DETRESERVA_FK
--==============================================================
create  index RESERVA_TIENE_DETRESERVA_FK on RESERVA (IDDETALLERESERVA ASC);

--==============================================================
-- Index: SOLICITUD_TIENE_RESERVA_FK
--==============================================================
create  index SOLICITUD_TIENE_RESERVA_FK on RESERVA (IDSOLICITUD ASC);

--==============================================================
-- Index: SOLICITUD_PK
--==============================================================
create unique index SOLICITUD_PK on SOLICITUD (IDSOLICITUD ASC);

--==============================================================
-- Index: PERSONAL_REALIZA_SOLICITUD_FK
--==============================================================
create  index PERSONAL_REALIZA_SOLICITUD_FK on SOLICITUD (IDUSUARIO ASC);

--==============================================================
-- Index: ENCARGADO_RECIBE_SOLICITUD_FK
--==============================================================
create  index ENCARGADO_RECIBE_SOLICITUD_FK on SOLICITUD (IDENCARGADO ASC);

--==============================================================
-- Index: TIPOGRUPO_PK
--==============================================================
create unique index TIPOGRUPO_PK on TIPOGRUPO (IDTIPOGRUPO ASC);

--==============================================================
-- Index: TIPOLOCAL_PK
--==============================================================
create unique index TIPOLOCAL_PK on TIPOLOCAL (IDTIPOLOCAL ASC);

--==============================================================
-- Index: ESTA_A_CARGO_FK
--==============================================================
create  index ESTA_A_CARGO_FK on TIPOLOCAL (IDENCARGADO ASC);

--==============================================================
-- Index: UNIDAD_PK
--==============================================================
create unique index UNIDAD_PK on UNIDAD (IDUNIDAD ASC);
...
--==============================================================
create  index PERSONAL_PERTENECE_UNIDAD_FK on USUARIO (IDUNIDAD ASC);
