...
DROP TRIGGER IF EXISTS delete_cascade_solicitud;
CREATE TRIGGER delete_cascade_solicitud
...
DROP TRIGGER IF EXISTS delete_cascade_reserva;
CREATE TRIGGER delete_cascade_reserva
...
DROP TRIGGER IF EXISTS update_fechafinreserva;
CREATE TRIGGER update_fechafinreserva
